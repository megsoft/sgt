...
exports.GetApplicationStatuslist = function (req, result) {
    ...
    async.series([
        ...
        function (callback) {
            ...
            var PageName = "ApplicationStatus";
        ...
        if (!err) {
            ...
            for (j = 0; j < eval(rows[0]).length; j++) {
                ...
                flexiformat += ' {       "id":"' + row.Id + '", "cell":["' + row.Id + '", "<b><a  id=itemedit_' + row.Id + ' >' + row.Status + '</a></b>" ,"<b><a  id=itemdelete_' + row.Id + ' >' + 'Delete' + '</a></b>"  ]    } ,';
            }
    ...
    result.render('PageApplicationStatus', {
        page_title: "Application Status - Node.js",
        data: flexiformat
    });
...
exports.GetApplicationStatusData = function (req, result) {
    var flexiformat = '';
    ...
    connection.query("CALL GetApplicationStatus('" + wherecond + "','" + sort + "'," + start + "," + rp + ");", function (err, rows) {
...
exports.save = function (req, res) {
    ...
    var Query = "insert into tblApplicationStatus  (Status) values ('" + req.body.Status+ "')";
...
exports.transact = function (req, result) {
    ...
    if (req.body.Id > 0 && req.body.action == "edit") {
        ...
        var Query = "update tblApplicationStatus set Status='" + req.body.Status + "'  where Id=" + req.body.Id + "";
        connection.query(Query, function (err, rows, fields) {
    ...
    /* delete code */
        ...
        var query = "delete FROM tblApplicationStatus WHERE Id=" + req.body.Id;
        connection.query(query, function (err, rows, fields) {
    ...
    /* Get Record by Id */
        ...
        var i = 1;
        var jsondata = '[';
        var query = "SELECT * FROM tblApplicationStatus WHERE id=" + req.body.Id;
        connection.query(query, function (err, rows, fields) {
