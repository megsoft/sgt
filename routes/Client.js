                ...
                connection.query(Query, function (err, rows) {
                    ...
                    if (!err) {
                        ...
                        for (j = 0; j < eval(rows[0]).length; j++) {
                            ...
                            flexiformat += ' {       "id":"' + row.Id + '", "cell":["' + row.Id + '", "<b><a  id=itemedit_' + row.Id + ' >' + row.FirstName + '</a></b>" ,"' + row.LastName + '","' + row.Address + '","' + row.CountryName + '","' + row.StateName + '","' + row.CityName + '","' + row.Mobile + '", "<b><a  id=itemdelete_' + row.Id + ' >' + 'Delete' + '</a></b>"  ]    } ,';
                        }
...
exports.GetClientData = function (req, result) {
    var flexiformat = '';
    var mysql = require('mysql');
    ...
    connection.query("CALL GetUser('" + wherecond + "','" + sort + "'," + start + "," + rp + ");", function (err, rows) {
...
exports.save = function (req, res) {
    ...
    var SubAgentId = req.session.userId;
    var Query = "insert into tblUser  (FirstName,Initial,LastName,Address,CountryId,StateId,CityId,Mobile,Email,ZipCode,IsActive,UserType,JobTitle,CompanyLegalName,CompanyDBA,CompanyFax,CompanyPhone,Website,RoleId,AgentId,SubAgentId) values ('" + req.body.FirstName + "','" + req.body.Initial + "','" + req.body.LastName + "','" + req.body.Address + "'," + req.body.CountryId + "," + req.body.StateId + "," + req.body.CityId + ",'" + req.body.Mobile + "','" + req.body.Email + "','" + req.body.Zipcode + "','" + Active + "','CLIENT','" + req.body.JobTitle + "','" + req.body.ComLegalName + "','" + req.body.ComDBA + "','" + req.body.ComFax + "','" + req.body.ComPhone + "','" + req.body.Website + "','79','" + AgentId + "','0')";
...
exports.transact = function (req, result) {
    ...
    if (req.body.Id > 0 && req.body.action == "edit") {
        ...
        var AgentId = req.session.AgentId;
        var SubAgentId = req.session.userId;
        var Query = "update tblUser set FirstName='" + req.body.FirstName + "',Initial='" + req.body.Initial + "',LastName='" + req.body.LastName + "' ,Address='" + req.body.Address + "',CountryId=" + req.body.CountryId + ",StateId=" + req.body.StateId + ",CityId=" + req.body.CityId + ",ZipCode='" + req.body.Zipcode + "',Email='" + req.body.Email + "',Website='" + req.body.Website + "',Mobile ='" + req.body.Mobile + "',JobTitle ='" + req.body.JobTitle + "',CompanyLegalName ='" + req.body.ComLegalName + "',CompanyDBA ='" + req.body.ComDBA + "',CompanyFax ='" + req.body.ComFax + "',CompanyPhone ='" + req.body.ComPhone + "',AgentId ='" + AgentId + "',SubAgentId ='" + SubAgentId + "' where Id=" + req.body.Id + "";
        connection.query(Query, function (err, rows, fields) {
    ...
    /* delete code */
        ...
        connection.query("delete FROM tblUser WHERE Id=" + req.body.Id, function (err, rows, fields) {
