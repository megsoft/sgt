...
exports.save = function (req, res) {
    ...
    var Query = "insert into tblUser  (FirstName,Initial,LastName,Address,CountryId,StateId,CityId,Phone,Mobile,Email,ZipCode,IsActive,UserType,RoleId) values ('" + req.body.FirstName + "','" + req.body.Initial + "','" + req.body.LastName + "','" + req.body.Address + "'," + req.body.CountryId + "," + req.body.StateId + "," + req.body.CityId + ",'" + req.body.Phone + "','" + req.body.Mobile + "','" + req.body.Email + "','" + req.body.Zipcode + "','" + Active + "','AGENT','77')";
        ...
        connection.query(Query, function (err, rows, fields) {
            ...
            if (!err) {
                ...
                var htmlcontent = "<table cellpadding='0' cellspacing='0' border='0' align='center' width='600'> " 
                    ...
                    + "   <a href='http://localhost:1337/AgentProfile?id=" + req.body.Id + "' style='line-height:0' target='_blank' data-saferedirecturl='https://www.google.com/url?hl=en&amp;q=http://www.skype.com/&amp;source=gmail&amp;ust=1467271905415000&amp;usg=AFQjCNFKE8GBj2PDd1AVpc6w0golHNm9og'>" 
                    ...
                    + " <br>" 
                    + "  You can now <a style='text- decoration:underline; color: #00aff0; font - weight:bold' href='http://localhost:1337/AgentProfile?id=" + req.body.Id + "' > Create password for your account</a>, view your profile or change your account settings.</div> " 
                    + " </td>" 
                    + " </tr>" 
                    + " </table>";
