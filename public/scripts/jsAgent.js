        ...
        xhr = $.ajax({
            ...
            success: function (msg, textStatus, xmlHttp) {
                ...
                if (msg.status == "saved") {
                    ...
                    $("#ptitle").html("Warning");
                    $("#mmsg").html(" Agent  : " + $("#txtFirstName").val() + " Already exists ");
                    $("#mmsg").css("color", "red");
                    $("#MessageModal").modal("show");
                    $("#txtFirstName").focus();
                }
...
function Edit() {
    if (validate()) {
       ...
       var password = randomPassword(10);
        ...
        $(".yellowwarning").html("required...");
        $(".yellowwarning").modal("show");
    }
}
