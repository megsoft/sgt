...
$(document).ready(function () {
    ...
    $("[id^=itemedit_]").live("click", function () {
        ...
        $("#myModalLabel").html('Edit Insurance');
        $('.YellowWarning').hide();
        $('.Warning').hide();
        var sourceCtl = $(this);
            ...
            xhr = $.ajax({
                ...
                success: function (msg, textStatus, xmlHttp) {
                    ...
                    if (msg.status == "saved") {
                        ...
                        $("#mmsg").css("color", "green");
                        $("#MessageModal").modal("show");
                        $("#fgrdData").flexReload({ url: "../Insurance" });
                        result = msg;
                        cancelAdd();
                    }
                    else if (msg.status == "ER_DUP_ENTRY") {
                        $("#ptitle").html("Warning");
                        $("#mmsg").html(" Insurance  : " + $("#txtType").val() + " Already exists ");
                        $("#mmsg").css("color", "red");
                        $("#MessageModal").modal("show");
                        $("#txtType").focus();
                    }
    ...
    function addclicked(com, grid) {
        $("#myModalLabel").html('Add Insurance');
        $("#txtType").val('');
        $("#Id").html('');      
        $('#EntryModal').modal('show');
        $(".YellowWarning").hide();
